...
function bones_register_sidebars() {
	register_sidebar(array(
		...
		'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="wpb_text_column">',
...
function bones_fonts() {
  wp_enqueue_style('googleFonts', '//fonts.googleapis.com/css?family=Lato&subset=latin,latin-ext');
}
